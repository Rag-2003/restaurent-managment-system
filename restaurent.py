...
def send():
    if textReceipt.get(1.0,END)=='\n':
        ...
        billLabel = Label(root2, text='Bill Details', font=('arial', 18, 'bold underline'), bg='yellow4', fg='white')
...
def receipt():
    ...
    if costoffoodvar.get() != '' or costofcakesvar.get() != '' or costofdrinksvar.get() != '':
        ...
        textReceipt.insert(END, f'Service Tax\t\t\t{16}Rs\n\n')
...
root.title('Restaurant Management System created by RAGHAV BIDSAR')
...
buttonSend=Button(buttonFrame,text='Send',font=('arial',14,'bold'),fg='white',bg='green4',bd=3,padx=5,command=send)
